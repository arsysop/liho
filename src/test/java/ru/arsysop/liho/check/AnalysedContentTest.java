...
import ru.arsysop.liho.check.comment.issues.DuplicatedCopyright;
import ru.arsysop.liho.check.comment.issues.NoCopyright;
import ru.arsysop.liho.check.comment.issues.NoLicenseHeader;
import ru.arsysop.liho.check.comment.java.JavaCommentType;
import ru.arsysop.liho.check.comment.segment.CopyrightAnalysis;
